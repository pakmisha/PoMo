<template>
  <ModalsModal name="consultation" class="modal modal-xl">
    <div class="modal-wrapper">
      <div class="text-center">
        ...
        <p class="text-xs text-grey md:text-sm">
          Как только наши менеджера освободятся, мы обязательно с Вами свяжемся.
      ...
      <button
        ...
        @click.prevent="$nuxt.$emit('close-modal', 'consultation')"
      >
        <svg
          width="16"
          height="16"
