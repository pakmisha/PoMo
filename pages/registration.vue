    ...
    <div class="section-container">
      ...
      >
        ...
        <p class="plaintext mx-auto max-w-[600px]">
          ...
          историю заказов и получить доступ к акциям, специальным предложениям,
          а также к дополнительному функционалу для профессиональных дизайнеров.
        </p>
      </div>
      <div class="auth">
        <div class="auth-wrapper">
          <form action="">
            ...
            <div
              class="mt-5 flex flex-col justify-between md:mt-10 md:flex-row"
            >
              <div class="flex">
                <UIButton
                  :loader="loading"
